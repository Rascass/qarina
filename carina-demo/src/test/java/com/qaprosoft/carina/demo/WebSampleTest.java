...
public class WebSampleTest extends AbstractTest {
    ...
    @Test(description = "JIRA#AUTO-0010")
    @MethodOwner(owner = "qpsdemo")
    public void testGoogleClassPosts() {
        GoogleClassHomePage homePage = new GoogleClassHomePage(getDriver());
        homePage.open();
        for (ExtendedWebElement element: homePage.getPosts()) {
    ...
    public void testAuthentification() {
        GoogleAuthentificationPage authentificationPage = new GoogleAuthentificationPage(getDriver());
        authentificationPage.open();
        authentificationPage.getInputEmailField().click();
        authentificationPage.getInputEmailField().sendKeys("yanaantonyuk001@gmail.com");
        authentificationPage.getNextButton().click();
    }
}
